public class Main {
    public static void main(String[] args) {
        {
            {
                ...
                //Представим, что мы работаем в небольшой компании. Данные сотрудников хранятся неструктурированном формате,
        ...
        String fullNameWithCapitalLetters = fullName.toUpperCase();
        System.out.println("Данные ФИО сотрудника для заполнения отчета —  " + fullNameWithCapitalLetters);
                System.out.println();
